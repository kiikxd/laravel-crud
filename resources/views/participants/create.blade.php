    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header bg-dark text-white text-center">
                <h2 class="card-title mb-0">Tambah Peserta</h2>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('participants.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="name" name="nama_peserta" placeholder="Masukkan nama peserta" required>
                    </div>
                    <div class="mb-3">
                        <label for="jurusan" class="form-label">Jurusan Peserta</label>
                        <input type="text" class="form-control" id="jurusan" name="jurusan" placeholder="Masukkan jurusan peserta" required>
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email Peserta</label>
                        <input type="email" class="form-control" id="email" name="email_peserta" placeholder="Masukkan Email" required>
                    </div>
                    <div class="mb-3">
