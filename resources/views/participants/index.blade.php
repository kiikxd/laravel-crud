    ...
    <div class="col-md-11">
        <div class="card">
            <div class="card-header bg-black text-white">
                <h2 class="card-title mb-0">Peserta IFC</h2>
            </div>
            <div class="card-body">
                <div class="col-sm-12">
                    <a href="{{ route('participants.create') }}" class="btn" style="margin: 5px 0; background-color:green; color:white">Create</a>
                    <a href="{{ route('print.participants') }}" class="btn btn-secondary" style="margin: 5px 0;">Print PDF</a>
                </div>
                        ...
                        @foreach ($participants as $index => $participant)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form method="post" action="{!! route('participants.destroy', $participant->id) !!}" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
                ...
                <div class="d-flex justify-content-center">
                    {!! $participants->links('pagination::simple-pagination') !!}
                </div>
            </div>
        </div>
    </div>
